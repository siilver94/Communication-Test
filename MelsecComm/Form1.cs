...
namespace DHVisionMelsecTest
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            tck = new TCPClient_PLC1("192.168.1.25", 2004, 100, this);


            plc1.TalkingComm += Plc1_TalkingComm;

            tck.TalkingComm += Tck_TalkingComm;
            tck.ConnectStart();
            Delay(300);
        ...
        private void Tck_TalkingComm(string name, object data, int length)
        {
            if (name.Equals("Data"))
            {
        ...
        private void modelOpen1(int modelnum)   //  모델 열기 함수1
        {
            ...
            try
            {
                ...
                // CogToolBlock Toools = (CogToolBlock)Cogtg.Tools["Tools"];

                //CogToolBlock CogToolBock1 = Toools.(CogToolBlock)Cogtg.Tools["CogToolBlock1"];
        ...
        private void button9_Click(object sender, EventArgs e)  //  PLC 데이터 쓰기
        {
            ...
            tck.MCWrite(Convert.ToInt32(Txt_Address.Text), Convert.ToInt32(Txt_Data.Text));
        }
